...
<head>
    ...
    <title>Harmse Digital Marketing</title>
</head>
<body>
    <header class="fixedToTop w-100">
        <div class="quickCTA d-flex">
            ...
            <ul class="d-flex flex-row my-0">
                <li><a href="https://www.Instagram.com/harmsedigital" class="quickCTAlinks responsiveText"><i class="fab fa-instagram"></i></a></li>
                <span class="mx-2"></span>
                <li><a href="https://www.facebook.com/Harmsemarketing" class="quickCTAlinks responsiveText"><i class="fab fa-facebook"></i></a></li>
                <span class="mx-2"></span>
                <li><a href="https://linkedin.com/company/HDmarketing" class="quickCTAlinks responsiveText"><i class="fab fa-linkedin"></i></a></li>
            </ul>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light d-flex flex-column whiteBG">
            <div class="container">
                <a class="navbar-brand" href="/">
                    <img class="img-fluid" width="150px" src="./img/harmse-marketing-logo.png"/>
                </a>
...
<!--        <div class="modal-footer">
    ...
    <header>
        <div class="heroDivMARImg d-flex flex-column align-items-center justify-content-center text-center">
            <h1 class="textHero"></h1>
            <h1 class="textBlueBG heroText textHero">DIGITAL MARKETING</h1>
    ...
    <article class="py-5">
        <div class="row mx-5 my-3">
            <div class="d-none d-md-block d-lg-block d-xl-block col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <img src="./img/marketing-about.jpg" class="img-fluid" />
            </div>

            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 d-flex flex-column justify-content-center pt-3">
                <h1>Digital Marketing</h1>
                <p>Digital marketing solutions for start-up businesses</p>
                
                <div class="d-flex row">
                    <ul class="col-sm-12 col-md-12 col-lg-6 col-cl-6">
                        <li><i class="fas fa-funnel-dollar"></i> Social Media Management</li>
                        <li><i class="fas fa-funnel-dollar"></i> Social Paid Ads</li>
                        <li><i class="fab fa-google"></i> Google Ads</li>
                        <li><i class="fab fa-google"></i> Google Business Veried</li>
                    </ul>

                    <ul class="col-sm-12 col-md-12 col-lg-6 col-cl-6">
                        <li><i class="fas fa-funnel-dollar"></i> Lead Generation Digital</li>
                        <li><i class="fas fa-funnel-dollar"></i> Magazine Advertising</li>
                    </ul>
                </div>
